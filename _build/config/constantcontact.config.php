...
$packageNameLower = 'constantcontact'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'ConstantContact',  /* No spaces, no dashes */
    ...
    'gitHubRepository' => 'ConstantContact',
    ...
    */
    ...
    'namespaces' => array(
        'constantcontact' => array(
            ...
            'path' => '{core_path}components/constantcontact/',
            'assets_path' => '{assets_path}components/constantcontact/',
        ),
    ...
    */
    ...
    'elements' => array(
        ...
        'plugins' => array(
            ...
            'ConstantContact' => array( /* constantcontact with static, events, and property sets */
                'category' => 'ConstantContact',
                ...
                'events' => array(
                    /* minimal constantcontact - no fields */

                    /* constantcontact with fields set */
                    'OnCustomerOrder' => array(
                        'priority' => '0', /* priority of the event -- 0 is highest priority */
                        'group' => 'plugins', /* should generally be set to 'plugins' */
                        'propertySet' => 'ccProperties', /* property set to be used in this pluginEvent */
                    ),
                ),
            ),
        ),
    ...
    */
    ...
    'cmpTemplates' => array (
         'mgr:<div id="constantcontact-panel-home-div"></div>',
    ),
